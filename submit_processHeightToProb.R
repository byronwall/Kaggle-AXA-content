...
filename = "submission_round4_noPCA.csv"
...
write.table(x = submit_noPCA, file = "submission_round4_probNoPCA.csv",
...
write.table(x = submit_PCA, file = "submission_round4_probWithPCA.csv", 
            row.names = FALSE, quote=FALSE, append=FALSE, sep=",",
            col.names = TRUE)
